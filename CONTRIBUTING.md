...
3. Run the project checks locally before pushing (format, lint, tests, build).
   The exact commands will be defined once the tech stack is chosen.
4. Open a pull request into `main`. CI must pass before merge.

## Setup

TODO: setup and local-run instructions once the stack is chosen.
